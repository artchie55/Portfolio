  ...
  return (
    ...
    <div  id='Container'  className='max-lg:hidden flex flex-col justify-center bg-[#ffffff] px-[40px] h-screen'>
      ...
      <left data-aos="fade-right" data-aos-duration="1000" className='w-[609px]'> 
        <div className='text-[70px] font-bold leading-[65px]'>
      ...
      <div data-aos="fade-right" data-aos-duration="1500" className='flex justify-center items-center ml-[-780px] mt-[100px]'>
